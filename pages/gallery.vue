...
const copy = {
  ...
  description: '১৯৭৫ সাল থেকে আমাদের শিক্ষার্থীদের জীবনযাত্রা, খেলাধুলা ও সাংস্কৃতিক গৌরব এবং ক্যাম্পাসের ঐতিহাসিক স্মৃতিবাহী আলোকচিত্রের এক অসাধারণ সংগ্রহশালা।',
